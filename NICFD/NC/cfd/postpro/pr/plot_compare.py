...
axes.plot(mesh3.iloc[:,-6] , mesh3.iloc[:,7]/Pc, 'k', lw=lwh, label="24k")
axes.plot(mesh4.iloc[:,-6] , mesh4.iloc[:,7]/Pc, 'r', lw=lwh, label="43k")
axes.plot(mesh5.iloc[:,-6] , mesh5.iloc[:,7]/Pc, 'g', lw=lwh, label="80k")
axes.plot(mesh6.iloc[:,-6] , mesh6.iloc[:,7]/Pc, 'b', lw=lwh, label="150k")
...
axes.plot(mesh3.iloc[:,-6] , mesh3.iloc[:,3], 'k', lw=lwh, label="24k")
axes.plot(mesh4.iloc[:,-6] , mesh4.iloc[:,3], 'r', lw=lwh, label="43k")
axes.plot(mesh5.iloc[:,-6] , mesh5.iloc[:,3], 'g', lw=lwh, label="80k")
axes.plot(mesh6.iloc[:,-6] , mesh6.iloc[:,3], 'b', lw=lwh, label="150k")
axes.yaxis.set_major_formatter(FormatStrFormatter('%.2f'))
...
axes.plot(mesh3.iloc[:,-6] , mesh3.iloc[:,1]/dc, 'k', lw=lwh, label="24k")
axes.plot(mesh4.iloc[:,-6] , mesh4.iloc[:,1]/dc, 'r', lw=lwh, label="43k")
axes.plot(mesh5.iloc[:,-6] , mesh5.iloc[:,1]/dc, 'g', lw=lwh, label="80k")
axes.plot(mesh6.iloc[:,-6] , mesh6.iloc[:,1]/dc, 'b', lw=lwh, label="150k")
...
# axes.plot(mesh4.iloc[:,-6] , mesh4.iloc[:,-1], 'b', lw=lwh, label="40k")
