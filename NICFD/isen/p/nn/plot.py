...
z75= pd.read_csv("z75.csv", ",", skiprows=0)
...
axes.plot(z75.iloc[:,2] , z75.iloc[:,3] , 'b', lw=lwh, label="$Z_t = 0.75$")
...
axes.plot(z75.iloc[:,2] , z75.iloc[:,4] , 'b', lw=lwh, label="$Z_t = 0.75$")
axes.set_xlabel('$P/P_t$',fontsize=12)
...
axes.plot(z75.iloc[:,2] , z75.iloc[:,5] , 'b', lw=lwh, label="$Z_t = 0.75$")
axes.set_xlabel('$P/P_t$',fontsize=12)
...
axes.plot(z75.iloc[:,2] , z75.iloc[:,6] , 'b', lw=lwh, label="$Z_t = 0.75$")
axes.set_xlabel('$P/P_t$',fontsize=12)
...
axes.plot(z75.iloc[:,2] , z75.iloc[:,7] , 'b', lw=lwh, label="$Z_t = 0.75$")
axes.set_xlabel('$P/P_t$',fontsize=12)
...
axes.plot(z75.iloc[:,2] , z75.iloc[:,8] , 'b', lw=lwh, label="$Z_t = 0.75$")
axes.set_xlabel('$P/P_t$',fontsize=12)
...
axes.plot(z75.iloc[0:98,2] , z75.iloc[0:98,9] , 'b', lw=lwh, label="$Z_t = 0.75$")
axes.set_xlabel('$P/P_t$',fontsize=12)
